...
def main():
    ...
    wp_mid   = navigator.getPoseStamped([-14.1,  -16.9], TurtleBot4Directions.EAST)    # Waypoint tengah
    ...
    # waypoint tengah initialized
    navigator.startToPose(wp_mid)
    time.sleep(5)
    ...
    navigator.info("mission 3 waypoint have finished...")
